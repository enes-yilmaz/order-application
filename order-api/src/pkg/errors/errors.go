...
const orderServiceApiOp string = "order-service.handler"

var (
	//CustomerInfoInvalid    = error.New(orderServiceApiOp, "Invalid Customer Infos are given", 1002, http.StatusBadRequest)
	CustomerNameInvalid    = New(orderServiceApiOp, "Invalid Customer name given, name length should be greater tha 3!", 1001, http.StatusBadRequest)
	CustomerEmailInvalid   = New(orderServiceApiOp, "Invalid Customer email given", 1002, http.StatusBadRequest)
